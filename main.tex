...
%%%
 ...
 % Author: Zihan
 % -----
 % Last Modified: Wednesday, 5th June 2024 12:41:40 am
...
% The major communication cost of our method is associated with collective operations such as \textit{Reduce_Scatter} and \textit{Allreduce}. The communication costs for these operations are $O\left(\alpha \cdot \log p + (\beta + \gamma) \cdot \frac{p-1}{p} n\right)$ and $O\left(2\alpha \cdot \log p + (2\beta + \gamma) \cdot \frac{p-1}{p} n\right)$, respectively.
