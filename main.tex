...
%%%
 ...
 % Author: Zihan
 % -----
 % Last Modified: Tuesday, 11th February 2025 11:39:00 am
...
\end{theorem}
Proof Sketch: Consider global objective $J(\mathbf{F})$ and its minimizer $\mathbf{F}^*$. The local optimality condition and block approximation error bounds combine via triangle inequality to yield the global deviation bound. Full proof appears in~\Cref{app}.
