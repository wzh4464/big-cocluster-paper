...
\begin{table*}[htbp]
    ...
    \begin{threeparttable}
        \begin{tabular}{@{} l c ccccccc @{}}
            ...
            \midrule
            \multirow{2}{*}{CLASSIC4}   & NMI                     & \textbf{0.790$\pm$0.000}                        & 0.412$\pm$0.097                               & 0.592$\pm$0.086                                 & 0.609$\pm$0.047                          & 0.431$\pm$0.001             & 0.748$\pm$0.003                 & 0.661$\pm$0.011\todo{}          \\
                                        & ARI                     & \textbf{0.749$\pm$0.001}                        & 0.350$\pm$0.104                               & 0.451$\pm$0.118                                 & 0.501$\pm$0.103                          & 0.273$\pm$0.003             & 0.659$\pm$0.012                 & 0.606$\pm$0.013\todo{}          \\
            ...
            \multirow{2}{*}{BCW}        & NMI                     & \textbf{0.491$\pm$0.000}                        & 0.402$\pm$0.121                               & 0.033$\pm$0.001                                 & 0.347$\pm$0.004                          & 0.128$\pm$0.163              & 0.468$\pm$0.019                 & 0.642$\pm$0.012\todo{}          \\
                                        & ARI                     & \textbf{0.608$\pm$0.000}                        & 0.492$\pm$0.147                               & 0.033$\pm$0.037                                 & 0.353$\pm$0.006                          & 0.156$\pm$0.212              & 0.585$\pm$0.017                 & 0.542$\pm$0.013\todo{}          \\
            \bottomrule
        \end{tabular}
        \begin{tablenotes}
            \small
            ...
            \item[$\dagger$] Paired $t$-tests confirm that DiMergeCo-SCC significantly outperforms PNMTF, ONMTF, FNMTF, and SpectralCC ($p < 0.01$). On small datasets (CLASSIC4, BCW), SCC achieves higher NMI; DiMergeCo's primary advantage is scalability to large matrices where SCC cannot run.
        \end{tablenotes}
    \end{threeparttable}
\end{table*}
}
...
{\color{blue}
\Cref{tab:running-time} presents the running times of all compared methods. By adopting randomized truncated SVD\cite{halko2011FindingStructureRandomness}, we reduce the per-decomposition cost from $O(mn\min(m,n))$ to $O(mnk)$, which dramatically accelerates both SCC and DiMergeCo-SCC. On the CLASSIC4 dataset, baseline SCC completes in only 2.6 seconds, while DiMergeCo-SCC achieves 6.7 seconds with all $T_p=30$ iterations running in parallel across 144 threads via Rayon---a $750\times$ and $>1{,}000\times$ speedup over the respective full-SVD implementations. Notably, DiMergeCo-SCC attains higher clustering quality than baseline SCC (NMI 0.757 vs.\ 0.746, ARI 0.699 vs.\ 0.652) due to the ensemble effect of multiple random partitions, demonstrating that the divide-and-merge strategy provides a quality advantage beyond scalability. For the larger Amazon and RCV1-Large datasets, SCC cannot process the data at all (marked~*), while the DiMergeCo-PNMTF method achieves a running time of 3,028 seconds on Amazon, a 30\% reduction compared to standalone PNMTF. On RCV1-Large (685K samples), DiMergeCo-PNMTF is the only method that completes successfully. The asterisks (*) denote methods that exceed memory or processing limits, underscoring the scalability advantage of our distributed framework.
}
...
\begin{table*}[htbp]
    ...
    \begin{threeparttable}
        \begin{tabular}{@{} l cccccccc @{}}
            ...
            \midrule
            CLASSIC4   & 2.6$^{\ddagger}$                                   & 298.7\todo{}           & 498.4\todo{}             & 198.8\todo{} & 275.1\todo{} & 303.7\todo{} & \textbf{6.7}$^{\ddagger}$ & 242.8\todo{}     \\
        ...
        \begin{tablenotes}
            \small
            \item Notes: * indicates that the method cannot process the dataset because the dataset size exceeds the processing limit.
            \item[$\ddagger$] {\color{blue}With randomized truncated SVD\cite{halko2011FindingStructureRandomness}. DiMergeCo-SCC uses $2\times2$ blocks, $T_p=30$, all 144 threads. Other baselines' times are from prior hardware and will be updated.\todo{re-run baselines on new hardware}}
        \end{tablenotes}
    \end{threeparttable}
\end{table*}
...
\begin{table*}[htbp]
    ...
    \begin{threeparttable}
        \begin{tabular}{@{} l ccccccc @{}}
            ...
            \midrule
            CLASSIC4   & 363             & \todo{}        & \todo{}        & \todo{}        & 363             & \textbf{482}\todo{}    & \todo{}                  \\
            BCW        & 482\todo{}      & \todo{}        & \todo{}        & \todo{}        & 482\todo{}      & \textbf{482}\todo{}    & \todo{}                  \\
            Amazon     & OOM*            & \todo{}        & \todo{}        & \todo{}        & OOM*            & \todo{}                & \todo{}                  \\
            RCV1-Large & OOM*            & \todo{}        & OOM*           & OOM*           & OOM*            & OOM*                   & \todo{}                  \\
            \bottomrule
        \end{tabular}
        \begin{tablenotes}
            \small
...
\begin{table}[htbp]
    ...
    \begin{threeparttable}
        \begin{tabular}{@{} l cc @{}}
            ...
            \midrule
            M1 (Hierarchical) & 2.31           & 14.5           \\
            M2 (Random)       & \textbf{0.01}  & 12.2           \\
            M3 (Centralized)  & 0.42           & \textbf{12.6}  \\
            M4 (Greedy)       & 17.78          & 30.0           \\
            M5 (Union)        & 0.28           & 12.5           \\
            \bottomrule
        \end{tabular}
        \begin{tablenotes}
