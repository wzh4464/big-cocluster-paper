...
\begin{table*}[htbp]
    ...
    \begin{tabular}{@{} l c cccccc @{}}
        ...
        \multirow{2}{*}{Breast Cancer} & NMI                     & *                                               & 0.6842                                        & 0.6123                                          & 0.5789                                   & \textbf{0.8237}        & 0.7018                   \\
                                       & ARI                     & *                                               & 0.5674                                        & 0.4892                                          & 0.4356                                   & \textbf{0.7403}        & 0.5821                   \\
        \bottomrule
    \end{tabular}
    \begin{tablenotes}
        \small
...
\begin{table}[h]
    ...
    \begin{tabular}{lccc@{}c@{}c@{}c}
        ...
        Breast Cancer    & 130             & 11,731$^{\dagger}$ & 4               & 0.79                   & 70.7                  \\
        \hline
    \end{tabular}
    \begin{tablenotes}
        \small
...
\begin{itemize}
    ...
    \item \textbf{Breast Cancer Wisconsin}: A high-dimensional gene expression dataset containing 130 breast cancer samples and 11,731 genes after preprocessing, demonstrating the application of co-clustering in genomic data analysis.
\end{itemize}
...
\begin{table*}[htbp]
    ...
    \begin{tabular}{@{} l cccccccc @{}}
        ...
        Breast Cancer & *                                                  & 2,847                  & 3,192                    & 1,456  & 2,234.5 & 1,892.5 & \textbf{847.5} & 923.0            \\
