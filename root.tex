...
{\color{blue}
\begin{proof}
    The proof follows from applying Hoeffding's inequality to the binomial distribution of co-cluster elements across partitions, treating row and column distributions independently. See \Cref{appendix:proofs} for the detailed proof.
\end{proof}
}
...
{\color{blue}
\begin{proof}
    The proof uses independence assumptions across multiple partitioning trials and applies the union bound over all co-clusters. See \Cref{appendix:proofs} for the detailed proof.
\end{proof}
}
...
\end{theorem}
\begin{proof}
    The proof follows from the additivity of the global objective function over disjoint partitions and the suboptimality assumption of local solutions. See \Cref{appendix:proofs} for the detailed proof.
\end{proof}
\begin{remark}
...
\end{lemma}
\begin{proof}
    The proof follows from the finite nature of the co-cluster set and the strictly decreasing property of the merge operation. See \Cref{appendix:proofs} for the detailed proof.
\end{proof}
