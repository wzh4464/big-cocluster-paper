...
\begin{algorithm}[!t]
    ...
    \begin{algorithmic}[1]
        ...
        \ENDIF
        \STATE Broadcast partition parameters using \texttt{MPI\_Bcast}($T_m$, $T_n$, $P_{\text{thresh}}$)
...
\begin{verbatim}
mpic++ -O3 -fopenmp -std=c++17 
    dimerge_co.cpp -o dimerge_co
mpirun -np 16 --hostfile nodes.txt
     ./dimerge_co \
    --matrix input.mtx 
    --blocks 10x10 --threshold 0.95
\end{verbatim}
