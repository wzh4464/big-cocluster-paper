...
\AR{We thank the reviewer for this important concern. DiMergeCo implements multiple protective mechanisms specifically designed to address small co-cluster fragmentation through theoretical guarantees and empirical validation.}
...
\textbf{Synthetic Validation:} We conducted controlled experiments on $2000 \times 1500$ matrices with co-clusters ranging from $10 \times 10$ to $400 \times 400$. Results show DiMergeCo achieves $94.2\%$ detection for tiny co-clusters ($10 \times 10$ to $25 \times 25$) versus $45\%$ for standard SCC.
