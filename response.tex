...
\textbf{Adaptive Block Sizing:} \Cref{alg:partitioning} dynamically expands block dimensions to protect detected co-clusters:
\begin{equation}
...
\AR{We thank the reviewer for this important suggestion to demonstrate broader domain applicability. We have substantially enhanced our experimental validation to encompass multiple distinct application domains.}
